...
sa_v_new:
    ld (ix+14),c
    ld a,1
    db 0xcb,0x71,0x28,0x01,0x3c,0xdd
...
db 0x80,0xeb,0xd1,0xe5,0xe5,0xdd,0xe1
    scf
    ld a,0xff
    db 0xcd,0x02,0x08
...
db 0xaf,0x11,0xa1,0x09,0xcd,0x0a,0x0c,0xfd,0xcb,0x02
db 0xee
...
; holds the number of lines to be scrolled and the C register holds zero.
    ...
    db 0x21,0xe0,0xff,0x19,0xeb
    db 0xed,0xb0,0x06,0x01,0xc5

    db 0xcd,0x9b,0x0e

db 0x0e,0x08,0xc5,0xe5,0x78,0xe6,0x07,0x0f
...
db 0x5d,0x5c,0xe7,0x21,0x92,0x5c,0x22,0x65,0x5c,0xcd,0x3b,0x2d
...
db 0x38,0x15,0x28,0x02,0xed,0x44,0xf5
...
db 0x2e,0x20,0x28,0xe7,0xcd,0x1b,0x2d,0x38,0x22,0x18,0x0a,0xe7
