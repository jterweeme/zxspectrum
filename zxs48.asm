...
; Next the attribute bytes are set as required. The value in ATTR-P will be
; used when handling the main part of the display and the value
...
db 0x00,0x40,0xe5,0xc5
    call copy_line
db 0xc1,0xe1,0x24,0x7c,0xe6,0x07,0x20,0x0a,0x7d
...
db 0x21,0xc3,0xd9,0x0d

; THE 'COPY-LINE' SUBROUTINE
; The subroutine is entered with the HL register pair holding the base
; address of the thirty two bytes that form the pixel-line and the B
...
copy_l_3:
    ...
    ld b,8
copy_l_4:
    db 0xcb,0x12,0xcb,0x13,0xcb,0x1a
copy_l_5:
    in a,(0xfb)
    rra
    jr nc,copy_l_5
...
db 0xb0,0x28,0x28,0xc5,0x03,0x03,0x03,0x03,0x2b,0xed,0x5b,0x53,0x5c,0xd5
db 0xcd,0x55,0x16
db 0xe1,0x22,0x53,0x5c,0xc1,0xc5,0x13,0x2a,0x61,0x5c,0x2b,0x2b,0xed,0xb8,0x2a
...
db 0xcd,0x55,0x16
db 0x23,0xe5,0xef,0x02,0x02,0x38,0xe1,0xeb,0x0e,0x0a,0xed,0xb0,0x2a
...
db 0x20,0x02,0xeb,0xe7,0xeb,0x01,0x06,0x00
db 0xcd,0x55,0x16
db 0x23,0x23,0x36,0x0e,0xfe
...
db 0xcd,0xee,0x1b
db 0xcd,0x30,0x25
db 0xe1,0xc8,0xe9,0x3e,0x03,0x18,0x02,0x3e,0x02,0xcd
...
db 0x88,0x2c,0x38,0xe7,0xfe,0x24,0xca,0xc0,0x2b,0x79,0x2a,0x59,0x5c,0x2b
db 0xcd,0x55,0x16
db 0x23,0x23,0xeb,0xd5,0x2a,0x4d,0x5c,0x1b,0xd6,0x06,0x47,0x28,0x11,0x23,0x7e
...
db 0xcd,0x55,0x16
db 0x23,0x77,0xc1,0x0b,0x0b,0x0b,0x23,0x71,0x23,0x70,0xc1,0x78,0x23
